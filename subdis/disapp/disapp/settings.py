...
SECRET_KEY = 'g+mv9mp@w77xsanmy6g)z$e+v7d&#2c&2o_r-j&cz#bv**&nc8'
...
STATIC_ROOT = os.path.join(BASE_DIR, "static/") # set up the static page path

STATICFILES_DIRS = ( os.path.join(BASE_DIR, "qa/static"), ) # note this
